...
| 生命走向衰减，照护只能延缓 | 退相干 | 以手护烛，亮度仍然只降不升 |
...
![总入场：未定字粒游移后，量子游园四字逐一凝定](docs/images/00-opening.jpg)

正式入口不是立刻抛出菜单。页面加载完成后，暗绢中先浮着一层尚未定形的字，“量、子、游、园”依次从乱码中凝定；“观之·即现”出现后，画面才淡入预备幕。整段约六秒半，点击画面、右下“略过”，或按 `Escape`、`Enter`、`Space` 都可以跳过。逐幕调试与设备检查不会重复播放片头。
...
| --- | --- | --- | --- |
| 壹 · 一園春 | 游园 | 先唤醒误闯后园的春香，听麗娘追问，再随二人越墙走过“日柳山松桐亭池” | 多个偶然条件同时成立，禁门才成为可行的路；园林随后沿人物脚步凝定 |
...
| 伍 · 離魂 | 闹殇 | 把手移到焰旁保护长命灯 | 观众能延缓衰减，却不能令生命倒流 |
...
左下角不是通关进度条，也不是戏曲导赏或汉字讲解。它是人物仍在现场时发出的另一层声部。

当指针或有效目光在一个物象附近稳定停留，那里会出现人物当场说的话、动作、迟疑或尚未拼完的线索；机关发生真实变化时，声部转为事件回执；只有观众需要继续操作、卡住或寻找出口时，它才给出行动提示。作品不会替观众回答“这一句象征了什么”，而是让答案藏在人物回头、停步、寻找声音和不敢越门的瞬间里。

第一幕尤其遵守“不提前知道”的原则。入园先在画面中央偏右唤春香：她因偶然误走，才发现府后藏着大花园；麗娘随即追问，却仍不敢动身。直到春香低声说出“老爷下乡，有几日了”，两人才越过由“墙／砖”组成的内墙。物理上只有一步，行动上却等了十六年。春香误闯、父亲离家、花径被清与观众唤醒共同形成一次低概率通路，这也是“量子”在第一幕真正进入叙事的地方。

越墙后，春香领路、麗娘观看，二人从春日、柳、山、松、桐、亭一路走到池边。观众可以继续观测，也可以完全停手，把这一幕当作一段自动展开的游园小戏。所有声部只留在她们此刻所见、所听与所做之中，不借物象剧透《寻梦》、写真、离魂或回生。
...
| 路径 | 职责 |
| --- | --- |
| `index.html` / `沉浸.html` | 播放总入场、维持跨幕全屏、承载预备幕与八幕路由 |
...
| `docs/量子游园·交互规格手册.md` | 八幕交互、左下题跋、声音与路由的完整舞台总谱 |
| `docs/量子游园·交互设计文档.md` | 观测模型、视觉语法、参数与已知风险 |
| `docs/量子游园·创作研究记录.md` | 现场反馈、文本证据、艺术判断与未决结构问题 |
